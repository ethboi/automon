...
export const WORLD_LOCATIONS = {
  ...
  dark_forest:    { position: [-36, 0, 22] as [number, number, number],    label: 'Dark Forest',     icon: '🌑', color: '#7c3aed', variant: 'none' as const,     route: null },
  crystal_caves:  { position: [32, 0, 24] as [number, number, number],  label: 'Crystal Caves',   icon: '💎', color: '#a78bfa', variant: 'none' as const,       route: null },
